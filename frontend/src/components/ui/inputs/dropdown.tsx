  ...
  return (
    <div className={`space-y-1.5 relative select-none ${className}`} ref={containerRef}>
      ...
      <button
        ...
        className={`w-full flex items-center justify-between px-3.5 py-2.5 border rounded-xl text-xs font-medium transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-indigo-500/15 active:scale-[0.99] cursor-pointer ${
          isOpen
