...
// // รายชื่อสมาชิกในทีม (ปรับ/เพิ่มชื่อจริงของบริษัทได้ตรงนี้)
// // ถ้าพิมพ์ชื่อที่ไม่มีในลิสต์ ก็ยังกดเพิ่มเป็นสมาชิกใหม่ได้อยู่ (ดูใน MultiSearchableSelect)
...
//   // สมาชิกทีมเก็บแยกเป็น array ต่างหาก แล้วค่อย join เป็น string ใส่ field `owner`
//   // ตอน submit (ไม่ต้องแก้ type SoloProject เดิม ใช้ร่วมกับหน้า Solo ได้)
...
//           {/* ===== ส่วนที่เพิ่มเข้ามาสำหรับทีม: เลือก/เพิ่ม/ลบสมาชิกทีมได้หลายคน ===== */}
//           <div>
...
//           <div>
//             <label className="block text-xs font-bold text-slate-800 mb-1">Progress (%)</label>
//             <input
//               type="number"
//               min="0"
//               max="100"
...
//               className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-xs font-semibold text-emerald-700 font-mono"
//             />
//           </div>
