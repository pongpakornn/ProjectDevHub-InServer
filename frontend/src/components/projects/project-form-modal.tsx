...
//       owner: formData.owner || "Pongpakorn",
...
//               {isEdit ? "ปรับปรุงข้อมูลรายละเอียดโครงการ" : "บันทึกข้อมูลหลักของโครงการเพื่อใช้แทน Excel Project Plan"}
//             </p>
//           </div>
//           <button
//             onClick={onClose}
...
//                 className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-xs font-semibold focus:outline-none focus:border-emerald-500"
//               />
//             </div>
//             <div>
