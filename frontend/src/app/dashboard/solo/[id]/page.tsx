...
//         {/* Banner ส่วนบน - Dynamic Dark Theme */}
...
//                   <div 
//                     className="bg-linear-to-r from-indigo-500 to-violet-500 h-full transition-all duration-500 shadow-[0_0_12px_rgba(99,102,241,0.5)]" 
...
//         {/* Card ส่วนล่าง - Pure White Content Box */}
...
//       {/* ============================================================================
//       * Phase Section - Auto Status & Dynamic Theme Edition
//       * ============================================================================ */}
...
//                   <th className="py-3.5 px-2 w-12 text-center font-mono text-[11px] uppercase tracking-wider text-slate-400">#</th>
//                   <th className="py-3.5 px-3 min-w-[220px] tracking-wide">Phase Name</th>
//                   <th className="py-3.5 px-3 w-36 tracking-wide">Owner</th>
//                   <th className="py-3.5 px-3 w-36 tracking-wide">Start Date</th>
//                   <th className="py-3.5 px-3 w-36 tracking-wide">End Date</th>
...
//                   const completedTasks = phase.items.filter((i) => i.completed).length;
...
//                             }}
//                             className="w-full px-2.5 py-1.5 bg-transparent border border-transparent hover:border-slate-200 focus:border-indigo-500 focus:bg-white rounded-md font-medium text-slate-800 transition-all focus:outline-none"
//                           />
//                         </td>
...
//                             }}
//                             className="w-full px-2.5 py-1.5 bg-transparent border border-transparent hover:border-slate-200 focus:border-indigo-500 focus:bg-white rounded-md text-slate-700 transition-all focus:outline-none"
//                           />
//                         </td>

//                         {/* Custom Styled Start Date Picker */}
//                         <td className="py-2.5 px-3">
...
//                               }}
//                               className="w-full pl-7 pr-2 py-1.5 bg-slate-50/70 hover:bg-white border border-slate-200/80 rounded-lg text-[11px] font-mono text-slate-700 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all cursor-pointer"
//                             />
//                             <Calendar className="w-3.5 h-3.5 text-slate-400 absolute left-2 pointer-events-none" />
//                           </div>
//                         </td>

//                         {/* Custom Styled End Date Picker */}
//                         <td className="py-2.5 px-3">
//                           <div className="relative flex items-center">
//                             <input 
//                               type="date" 
...
//                         {/* ⚡ Auto Status Indicator (Replaced Dropdown) */}
//                         <td className="py-2.5 px-3">
//                           <div
//                             className={`flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-[11px] font-bold border transition-all duration-300 w-fit select-none ${
//                               isDone
...
//                         {/* Progress Bar (Dynamic Colors: Slate -> Indigo -> Emerald) */}
//                         <td className="py-2.5 px-3">
//                           <div className="flex items-center gap-2">
...
//                               />
//                             </div>
//                             <span className="font-mono text-[11px] font-bold text-slate-600 min-w-[34px] text-right">
//                               {phaseProgress}%
//                             </span>
//                           </div>
//                         </td>
...
//                       {/* Sub-task List Section (Expandable Area) */}
//                       <tr>
...
//                                     <span className="w-1.5 h-1.5 rounded-full bg-indigo-500" />
//                                     รายการ Sub-tasks ในเฟสนี้ ({completedTasks}/{totalTasks})
//                                   </h4>
//                                 </div>
...
//               className="w-auto! bg-indigo-600 hover:bg-indigo-700 shadow-[0_4px_12px_rgba(79,70,229,0.25)] hover:shadow-[0_6px_16px_rgba(79,70,229,0.4)] normal-case text-xs font-bold px-4 py-2 self-end h-[38px] flex items-center gap-1"
//             >
//               <Plus className="w-3.5 h-3.5" />
//               เพิ่ม
//             </Button>
