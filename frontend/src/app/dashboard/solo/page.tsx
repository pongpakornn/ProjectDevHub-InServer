...
//   // คำนวณความคืบหน้ารวมแบบ Dynamic ผ่าน helper function
...
//       <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#0d131f] via-[#0b1a20] to-[#062922] border border-slate-800/80 p-6 md:p-8 shadow-xl">
...
//             <div className="bg-slate-900/60 border border-emerald-500/20 rounded-xl p-4 min-w-[280px] space-y-2.5 backdrop-blur-md shadow-lg shadow-black/20">
//               <div className="flex items-center justify-between text-xs">
//                 <span className="text-slate-200 font-semibold flex items-center gap-2">
//                   <Activity className="w-4 h-4 text-emerald-400" />
//                   ความคืบหน้ารวม
//                 </span>
//                 <span className="text-emerald-400 font-mono font-extrabold text-base">{avgProgress}%</span>
//               </div>
...
//                   <th className="py-3.5 px-3.5 min-w-[110px]">OWNER</th>
...
//                         >
//                           <div className="p-1.5 rounded-lg bg-slate-100 border border-slate-200 text-slate-500 group-hover/item:text-emerald-600 group-hover/item:border-emerald-400 group-hover/item:bg-emerald-50 transition-all shrink-0 mt-0.5">
//                             <FolderGit2 className="w-3.5 h-3.5" />
//                           </div>
//                           <div>
//                             <h3 className="font-bold text-slate-900 text-xs group-hover/item:text-emerald-600 transition-colors underline-offset-2 group-hover/item:underline">
//                               {project.name}
//                             </h3>
...
//                       <td className="py-3.5 px-3.5 font-mono font-bold text-slate-600">{project.owner}</td>
//                       <td className="py-3.5 px-3.5">
...
//                             <div
//                               className={`h-full rounded-full transition-all duration-300 ${currentProgress === 100 ? "bg-emerald-500" : "bg-amber-500"}`}
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-950 border-b border-slate-800 text-[11px] font-mono font-bold text-slate-300 uppercase tracking-wider">
                  <th className="py-3.5 px-3.5 w-12 text-center text-slate-400">NO</th>
                  <th className="py-3.5 px-3.5 min-w-[260px]">PROJECT</th>
                  <th className="py-3.5 px-3.5 min-w-[130px]">OWNER</th>
                  <th className="py-3.5 px-3.5 w-20">PRIORITY</th>
                  <th className="py-3.5 px-3.5 w-24">START</th>
                  <th className="py-3.5 px-3.5 w-24">END</th>
                  <th className="py-3.5 px-3.5 w-28">STATUS</th>
