    ...
    <div className="w-full space-y-6 pb-12 text-slate-800">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button 
            ...
            className="flex items-center gap-1.5 px-4 py-2 rounded-lg bg-[#2eab55] hover:bg-[#28964a] text-white text-xs font-bold transition-all shadow-sm"
          >
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-xs space-y-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-xs">
          ...
          <div>
            <span className="text-slate-400 font-medium block mb-1">Owner</span>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-xs">
          ...
          <div>
            ...
            <div className="w-full bg-slate-100 rounded-full h-2 overflow-hidden border border-slate-200 mt-1.5">
              <div 
                className="bg-[#2eab55] h-full transition-all duration-300" 
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-xs space-y-4">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          <div className="flex items-center gap-2">
            <span className="bg-emerald-100 text-emerald-800 font-bold px-2 py-1 rounded text-xs">Phase / ลำดับงาน</span>
            
            <button 
              onClick={handleAutoGeneratePhases}
              title="สร้าง Phase อัตโนมัติตามมาตรฐาน"
              className="p-1.5 bg-emerald-50 hover:bg-emerald-100 text-emerald-700 rounded-lg border border-emerald-200 transition-all flex items-center gap-1 text-xs font-medium"
            >
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            <input 
              ...
              className="px-3 py-1.5 border border-slate-200 rounded-lg text-xs w-full sm:w-48 focus:outline-none focus:border-emerald-500"
            />
            <button 
              onClick={handleAddPhase}
              className="px-3 py-1.5 bg-[#2eab55] hover:bg-[#28964a] text-white rounded-lg text-xs font-bold flex items-center gap-1 shrink-0"
            >
                    ...
                    >
                      ...
                      <td className="py-3 px-3">
                        <input 
                          ...
                          className="w-full px-2 py-1 border border-slate-200 rounded font-medium focus:outline-none focus:border-emerald-500"
                        />
                      </td>
                      <td className="py-3 px-3">
                        <input 
                      ...
                      <td className="py-3 px-3 font-mono font-bold">
                        <div className="flex items-center gap-2">
                          <div className="flex-1 bg-slate-100 rounded-full h-2 border border-slate-200 overflow-hidden">
                            <div 
                              className={`h-full ${phaseProgress === 100 ? "bg-emerald-500" : "bg-amber-500"}`} 
                          ...
                          <div className="pl-8 space-y-3">
                            ...
                            <div className="flex flex-col sm:flex-row items-center gap-2 pt-2">
                              <input 
                                ...
                                className="flex-1 px-3 py-1.5 border border-slate-200 rounded-lg text-xs w-full focus:outline-none focus:border-emerald-500"
                              />
                              <input 
                                type="text" 
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-3 items-end">
          ...
          <div className="flex gap-2">
            ...
            <button 
              ...
              className="px-4 py-2 bg-[#2eab55] hover:bg-[#28964a] text-white font-bold rounded-lg text-xs self-end h-[38px] flex items-center gap-1"
            >
              <Plus className="w-3.5 h-3.5" />
              เพิ่ม
            </button>
            ...
            <div className="flex flex-wrap gap-2">
              {stacks.map((st) => (
                <div key={st.id} className="flex items-center gap-2 px-3 py-1.5 bg-slate-50 border border-slate-200 rounded-lg text-xs font-medium">
                  ...
                  <span className="text-[10px] bg-emerald-50 text-emerald-700 px-1.5 py-0.5 rounded border border-emerald-200">{st.layer}</span>
              ...
              {phases.map((phase, idx) => (
                <div key={phase.id} className="grid grid-cols-12 py-2.5 items-center hover:bg-slate-50">
                  ...
                  <div className="col-span-8 relative h-5 bg-slate-50 rounded border border-slate-100 flex items-center px-1">
                    {phase.startDate && (
                      <div 
                        className="h-3.5 bg-emerald-600 rounded shadow-xs" 
                        style={{
                          marginLeft: `${(idx * 8) % 70}%`,
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button 
              ...
              className="px-3 py-1.5 bg-[#2eab55] hover:bg-[#28964a] text-white rounded-lg text-xs font-bold flex items-center gap-1"
            >
              <Plus className="w-3.5 h-3.5" />
              เพิ่มผลงาน
            </button>
          ...
          <div className="bg-white rounded-2xl max-w-md w-full p-6 space-y-4 shadow-xl">
            ...
            <div className="space-y-3 text-xs">
              ...
              <div>
                ...
                <textarea 
                  ...
                  className="w-full px-3 py-2 border border-slate-200 rounded-lg h-20 focus:outline-none focus:border-emerald-500"
                />
              </div>
              ...
              <div>
                ...
                <textarea 
                  ...
                  className="w-full px-3 py-2 border border-slate-200 rounded-lg h-20 focus:outline-none focus:border-emerald-500 font-mono text-[11px]"
                />
              </div>
            ...
            <div className="flex justify-end gap-2 pt-2 border-t border-slate-100">
              ...
              <button 
                ...
                className="px-4 py-2 bg-[#2eab55] hover:bg-[#28964a] text-white font-bold rounded-lg text-xs"
              >
                บันทึก
              </button>
            </div>
