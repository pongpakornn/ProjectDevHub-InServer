...
// ===========================================================================
// บัญชีที่เคยเข้าสู่ระบบล่าสุด — จำ EmpId/ชื่อไว้เพื่อคลิกเติมช่อง Username ให้อัตโนมัติในหน้า Login เสมอ
// ส่วนรหัสผ่านจะถูกจำไว้ด้วย "เฉพาะเมื่อผู้ใช้ติ๊กช่อง จดจำรหัสผ่าน" ตอนล็อกอินเท่านั้น (เก็บเป็นข้อความธรรมดา
// ใน LocalStorage ของเครื่องนั้นๆ — เหมาะกับเครื่องส่วนตัว/ในองค์กรที่ไว้ใจได้ ไม่ควรติ๊กบนเครื่องสาธารณะ)
// ===========================================================================
